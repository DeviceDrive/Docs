This page allows you to define rules for devices to be automatically upgraded to specific product versions.
...
4. Register or edit an upgrade rule to upgrade devices to a specific version.
