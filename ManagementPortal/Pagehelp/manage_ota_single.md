This page allows you to upgrade a single device to a particular product version. Device UID
(12 character hardware address) must be known in advance. A product version contains
